...
import dogWEB from '../images/dog.webp';
    ...
    return (
      <>
        <section className="py-3">
              ...
              <div className="col-md-12">
                <div className="show-area d-flex align-items-center justify-content-center">
                  <div className="show-img d-flex p-2 bg-light">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href={`https://www.linkedin.com/shareArticle?mini=true&url=${this.state.dogs}`} className="share-icon linkedin">
                      <FaLinkedinIn />
                    </a>
                  </div>
                      <div className="icon mx-1">
                        ...
                        <a target="_blank" rel="noopener noreferrer" href={`https://twitter.com/intent/tweet?url=${this.state.dogs}`} className="share-icon twitter">
                          <FaTwitter />
                        </a>
                      </div>
                      <div className="icon mx-1">
                        ...
                        <a target="_blank" rel="noopener noreferrer" href={`https://pinterest.com/pin/create/button/?url=${this.state.dogs}`} className="share-icon pinterest">
                          <FaPinterestP />
                        </a>
                      </div>
                      <div className="icon mx-1">
                        ...
                        <a target="_blank" rel="noopener noreferrer" href={`https://www.facebook.com/sharer/sharer.php?u=${this.state.dogs} `} className="share-icon facebook">
                          <FaFacebookF />
                        </a>
                      </div>
                      ...
                      <div className="icon mx-1">
                        ...
                        <CopyToClipboard text={this.state.dogs}>
                          <div
          ...
          <div className="w-100 h-100 dog-bg">
          {isWebpSupported()
            ? <img alt="" className="img-fluid" src={dogWEB} />
            : <img alt="" className="img-fluid" src={dogJPG} />
          }
        </div>
        </section>
      </>
